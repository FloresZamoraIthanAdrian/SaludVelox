...
function cambiarContrasena(cambiarContrasenaForm){
    
    console.log("Funciona qpd");
    
    if(cambiarContrasenaForm.nuevaContrasena.value.length > 20 || cambiarContrasenaForm.nuevaContrasena.value.length < 6){
        alert('La contraseña tiene un maximo de 20 caracteres y minimo de 6');
        return false;
    }

    if(cambiarContrasenaForm.nuevaContrasena.value != cambiarContrasenaForm.VerificarContrasena.value){
        verificarDatos = false
        alert('La contraseñas deben coincidir');
        return false;
    }
