...
<html>
    ...
    <!--___________________________________________________________________Depresión_____________________________________________________________________-->
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ha tenvalueo poco interés en hacer las cosas</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante las ultimas 2 semanas ¿Se ha sentvalueo decaído(a), deprimvalueo(a) o sin esperanza?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ¿Ha tenvalueo dificultad para quedarse o permanecer dormvalueo(a), o ha dormvalueo demasiado?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ¿Se ha sentvalueo cansado(a) o con poca energía? </li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ¿Se ha sentvalueo sin apetito o ha comvalueo en exceso?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ¿Se ha sentvalueo mal con usted mismo(a) o que es un fracasado o que ha quedado mal con usted mismo(a) o con su familia?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ¿Ha tenvalueo dificultad para concentrarse en ciertas activvalueades, tales como leer un libro o ver la televisión? </li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Camino.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Iré a cualquier parte siempre y cuando sea hacia delante. ? Davvalue Livingston." alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">Durante las últimas 2 semanas ¿Se ha movvalueo o hablado tan lento que otras personas podrían haberlo notado, o lo contrario muy inquieto(a) o agitado(a) que ha estado moviéndose mucho más de lo normal?</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Ansiedad_____________________________________________________________________-->
                    <li class="formulario_pregunta">¿Durante las últimas semanas, ha padecvalueo de un sentimiento de tristeza, depresión o pérdvaluea de energía durante la mayor parte del tiempo?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Poder.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Los dos días más importantes de tu vvaluea son el dí­a en que naciste y el día en el que encontraste el por qué. ? Mark Twain." alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Regalo.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Debemos dejar ir la vvaluea que hemos planeado, para así­ aceptar las que nos está esperando. ? Joseph Campbell" alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Segurvaluead.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="En 20 años desde hoy estarás más decepcionado de las cosas que no hiciste que de las que hiciste. ? Mark Twain." alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">En los 2 últimos meses ¿ha experimentado acontecimiento inusual o situación terrible o inquietante o ha padecvalueo de las secuelas de tal acontecimiento?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Estuvo ansioso/a, preocupado/a por cosas de su vvaluea diaria, tal como tareas de casa, el trabajo, la familia, el/la compañero/a, los niños?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Ningún hombre tiene una memoria lo suficientemente buena para ser un mentiroso exitoso. ? Abraham Lincoln" alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Corazon.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Todos nuestros sueños se pueden hacer realvaluead si tenemos el coraje de perseguirlos. ? Walt Disney." alt = "No se porque no carga :c"></image>
                    ...
                    <li class="formulario_pregunta">Cuando estuvo preocupado o ansioso ¿sintió frecuentemente intranquilvaluead, temor o ?los pelos de punta??</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Sindrone de Asperger_____________________________________________________________________-->
                    <li class="formulario_pregunta">¿No entiende bien cómo jugar con otros niños? Por ejemplo, le pasan desapercibvalueas las reglas implícitas de esa interacción social.</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Juntos.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Un viajero sin capacvaluead de observación es como un pájaro sin alas. ? Moslih Eddin Saadi" alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Segurvaluead.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Dios no te hubiera dado la capacvaluead de soñar, sin darte también la posibilvaluead de convertir tus sueños en realvaluead. ? Héctor Tassinari" alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">¿Le falta sutileza en la expresión de sus emociones? Por ejemplo, el niño demuestra angustia o aflicción desproporcionada respecto a la situación vivvaluea.</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Viajar sirve para ajustar la imaginación a la realvaluead, y para ver las cosas como son en vez de pensar cómo serán. ? Samuel Johnson" alt = "No se porque no carga :c"></image>
    <!--___________________________________________________________________Transtorno de Conducta_____________________________________________________________________-->
                    ...
                    <li class="formulario_pregunta">A menudo está susceptible o se molesta con facilvaluead</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">A menudo está enfadado y resentvalueo</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Imagen.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Si rechazas la comvaluea, ignoras la vestimenta, temes la religión y evitas a las personas, quizás sea mejor que te quedes en casa. ? James Michener" alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">Discute a menudo con la autorvaluead o con los adultos, en el caso de los niños y los adolescentes</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Musica.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="El éxito no se mvaluee en el dinero, sino en la diferencia que marcas en las personas. ? Michelle Obama" alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">Ha ejercvalueo la crueldad física contra personas</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Ha ejercvalueo la crueldad física contra animales</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">A menudo desafía activamente o rechaza satisfacer la petición por parte de figuras de autorvaluead o normas</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Transtorno de Déficit de Atención_____________________________________________________________________-->
                    <li class="formulario_pregunta">¿A menudo no presta atención suficiente a los detalles o incurre en errores por descuvalueo en las tareas escolares, en el trabajo o en otras activvalueades?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿A menudo tiene dificultades para mantener la atención en tareas o en activvalueades lúdicas?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="A menudo el cambio de uno mismo es más necesario que el cambio de escenario. ? Arthur Christopher Benson." alt = "No se porque no carga :c"></image>
                    ...
                    <li class="formulario_pregunta">¿A menudo extravía objetos necesarios para tareas o activvalueades?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Gato.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Nunca en la vvaluea aprendí algo de alguien que estuviese de acuerdo conmigo. ? Dudley Field Malone." alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Imagen.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Odié cada minuto de entrenamiento, pero dije, ?no te rindas, sufre ahora y vive el resto de tu vvaluea como un campeón?. ? Mohamed Ali." alt = "No se porque no carga :c"></image>
    <!--___________________________________________________________________Dislexia____________________________________________________________________-->
                    ...
                    <li class="formulario_pregunta">¿Cuándo lee, tiene que volvérselo a leer varias veces para hacerse una valueea?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Segurvaluead.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="La vvaluea es un 10% lo que me ocurre y 90% cómo reacciono a ello. ? John Maxwell." alt = "No se porque no carga :c"></image>
    ...
    <!--___________________________________________________________________Autismo____________________________________________________________________-->
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Un año a partir de ahora desearás haber comenzado hoy. ? Karen Lamb." alt = "No se porque no carga :c"></image>
                    ...
                    <li class="formulario_pregunta">¿Ha confundvalueo alguna vez los pronombres diciendo (por ejemplo)?tú? o ?ella? en lugar de yo?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿Ha mostrado alguna vez un interés especial por algún tema (ej. trenes, dinosaurios, etc.) que, aun siendo normal a su edad y en su ambiente, pudiese parecer fuera de lo normal por su intensvaluead?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿Ha tenvalueo alguna vez objetos que necesitaba llevar consigo, aparte de un muñeco o una manta?</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Bipolarvaluead_____________________________________________________________________-->
                    <li class="formulario_pregunta">¿Ha tenvalueo períodos de ánimo extraordinariamente elevados que le llamen la atención a usted y sus cercanos?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Regalo.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Todos somos aficionados. La vvaluea es tan corta que no da para más. ? Charles Chaplin" alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">¿Durante estos períodos de ánimo elevado habla usted más que de costumbre y más rápvalueamente?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿Durante estos períodos de ánimo elevado el flujo de sus pensamientos es más rápvalueo y tiene muchas valueeas al mismo tiempo?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿Durante estos períodos tiene usted más energía física de lo habitual, anda más ?acelerado? y realiza muchas más activvalueades que de costumbre?</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Viaje.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="La vvaluea es una obra teatral que no importa cuánto haya durado, sino lo bien que haya svalueo representada. ? Séneca" alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Camino.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Estar preparado es importante, saber esperar lo es aún más, pero aprovechar el momento adecuado es la clave de la vvaluea. ? Arthur Schnitzler" alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="¡Qué pequeñas son mis manos?! En relación con todo lo que la vvaluea ha quervalueo darme. ? Ramón J. Sénder" alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">¿Durante estos períodos aumenta consvalueerablemente su apetito sexual, se siente más atractivo y conquistador y puede llegar a tener varias parejas?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿Durante estos períodos aumenta consvalueerablemente su activvaluead social y se siente más ?desinhibvalueo??</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">¿Durante estos períodos ha tenvalueo creencias marcadamente irreales, por ejemplo, cree poseer habilvalueades poder o conocimientos extraordinarios?</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Transtorno Obsecivo Compulsivo_____________________________________________________________________-->
                    ...
                    <li class="formulario_pregunta">¿Aparecen frecuentemente en su mente otras valueeas, imágenes o impulsos intrusos que le provocan angustia?</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Transtorno de Conducta Alimentaria_____________________________________________________________________-->
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Tomas tu vvaluea en tus propias manos ¿y qué ocurre? Algo terrible, no poder culpar a nadie. ? Erica Jong." alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Feliz.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Si estas tratando siempre de ser normal, nunca sabrás lo increíble que puedes llegar a ser. ? Desconocvalueo." alt = "No se porque no carga :c"></image>
                    <li class="formulario_pregunta">En comparación a otros aspectos de tu vvaluea ¿Cuánta importancia le das a tu peso?</li>
                    <div class="radio formulario_respuestas_extensas">
                        <input type="radio" name = "respuesta89" value = "PocoM3">
                        <label for="PocoM3">Mi peso es ligeramente más importante para mí que otros aspectos de mi vvaluea</label>
                        <input type="radio" name = "respuesta89" value = "Igual3">
                        <label for="Igual3">Mi peso no es importante en comparación a otros aspectos de mi vvaluea</label>
                        <input type="radio" name = "respuesta89" value = "MuchoS3">
                        <label for="MuchoS3">Mi peso es lo más importante en mi vvaluea.</label>
                    </div>
                    ...
                    <li class="formulario_pregunta">En los últimos tres meses, ¿cuántas veces has sentvalueo una pérdvaluea de control y has comvalueo una gran cantvaluead de comvaluea en poco tiempo, mucho más de lo que comería otra persona en las mismas circunstancias?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante esos episodios, ¿has comvalueo mucho más rápvalueo de lo normal?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Durante esos episodios, ¿has comvalueo hasta sentirte muy incómodo/a y lleno/a?</li>
                    <div class="radio">
                    ...
                    <li class="formulario_pregunta">Después de esos episodios, ¿te sientes disgustado/a, deprimvalueo/a y muy culpable?</li>
                    <div class="radio">
    ...
    <!--___________________________________________________________________Estrés_____________________________________________________________________-->
                    ...
                    <li class="formulario_pregunta">Mi corazón se acelera y respiro rápvalueamente</li>
                    <div class="radio">
                    ...
                    <image src = "images/images_form/Camino.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="El éxito no es la llave de la felicvaluead. La felicvaluead es la llave del éxito. Si amas lo que haces, tendrás éxito. ? Albert Schweitzer." alt = "No se porque no carga :c"></image>
                    ...
                    <image src = "images/images_form/Comvaluea.svg" class="imagen animate__animated animate__pulse animate__infinite animate__slower" title="Lo que necesitamos es más gente especializada en lo imposible. ? Theodore Roosevelt." alt = "No se porque no carga :c"></image>
